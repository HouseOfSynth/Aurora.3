		...
		if(prob(5))
			...
			switch(pick(1,2,3,4,5,6,7,8))
				...
				if(5)
					...
					message = pick("YOUR FUND HAS BEEN MOVED TO [pick("Ohio","Biesel","Dominia","Elyra","Qerrbalak","Adhomai","NTCC Odin","Hephaestus","NSS Upsilon")] DEVELOPMENTARY BANK FOR ONWARD REMITTANCE.",\
