...
/datum/language/human
	...
	desc = "With its roots in Mandarin Chinese, Common evolved as the official language of the Ohio Alliance, with officials working to tie it together with a common tongue. It's spoken by state officials, taught in schools, and spoken by those who either feel a sense of national pride in the Alliance or otherwise fell sway to the culture."
	speech_verb = "says"
